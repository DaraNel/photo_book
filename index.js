const studentsData = [
  {
    ...
    quotes: "<strong>QUOTES:</strong> If you think responsive’s simple, I feel bad for you son. We got 99 viewports, but the iPhone’s just one. - <strong>Josh Brewer</strong>",
  ...
  },
  {
    ...
    favLangs: ["HTML", "CSS","JavaScript", "PHP"],
    quotes: "<strong>QUOTES:</strong> Technology is nothing. What’s important is that you have faith in people, that they’re good and smart, give them tools, they’ll do wonderful things.” – <strong>Steve Jobs</strong>",
...
function studentTemplate(student)  {
  return `
  <div class ="student">
  <img class="student-photo" width="600" height="600" src="${student.photo}">
...
document.getElementById("app").innerHTML = `
    ...
    <p class="footer">These ${studentsData.length} students of LAW 1 were added recently. Check back soon for updates: <strong>Copyright &copy;Dara Nelson, 2020</strong></p>
`;
